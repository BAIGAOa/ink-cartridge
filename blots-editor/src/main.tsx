  ...
  return (
    <Box flexDirection="column" padding={1}>
      <Box
        ...
        paddingLeft={2}
      >
        <Text bold>{currentMode}</Text>
      </Box>
      <Box paddingX={1} height="100%" width="100%" backgroundColor="#1E1E1E">
        <Editor
          focusId="editor-main"
          value={text}
          onChange={setText}
