...
- Clears non-`crossPage` layers and modal layers. `crossPage` layers and modal layers survive; keyboard focus is automatically restored when returning to the originating screen.
