import type { ButtonType, ESCMouseEvent, MouseEventAction, SGRMouseEvent } from '../types/index.js';

import { ANSI_RESPONSE_PATTERNS, MAX_EVENT_LENGTHS } from './constants.js';
